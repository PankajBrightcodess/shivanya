...
error_reporting(0);
  ...
  $pg=$cpage[0];
?>
<nav class="navbar navbar-expand-lg navbar-light" style="background-color: #4BA4DE;">
	<div class="container-fluid">
		<a class="navbar-brand" href="index.php"><h2 class="text-light">Diet</h2></a>
        ...
        <!--  <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="AboutVEWT">
			...
			<!-- 	<li class="nav-item">
					<a class="nav-link <?php if($pg=="add_banner"){ echo "active";} ?>" href="add_banner.php">Add Banner</a>
				</li>
				<li class="nav-item">
